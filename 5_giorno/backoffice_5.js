...
class Mobilephone {
  ...
  const submitEvent = function (e) {
    ...
    const brandInput = document.getElementById('brand') // input field del campo price
    const imageUrlInput = document.getElementById('imageUrl') // input field del campo time
    const priceInput = document.getElementById('price') // input field del campo time
  
    const concertFromForm = new Mobilephone(
      nameInput.value,
    ...
    console.log('PRODOTTO DA INVIARE ALLE API', concertFromForm)
