...
let eyeColor = {
  ...
  brown: [],
  red: [],
  'blue-gray': [] //blue-gay è tra '' perchè ha un carattere speciale in mezzo
};
...
for (let c = 0; c < starWarsCharacters.length; c++) {
  let character = starWarsCharacters[c];
...
let crewMass = 0;
let d = 0;
while ( d < starWarsCharacters.length){
  crewMass += starWarsCharacters[d].mass; // += addizione o concatenazione 
  d++;
}
